			...
			<div class="w3_login_module">
				...
				<div class="form">
					...
					<form action="AddUser" method="post">
					  ...
					  <input type="text" name="umob" placeholder="Phone Number" required=" ">
					   <input type="text" name="uadress" placeholder="Adress" required=" ">
					  <input type="password" name="upassword" placeholder="Password" required=" ">
					   <input type="text" name="lat" value="<%=lat %>" placeholder="text" required=" ">
					        <input type="text" name="lng" value="<%=lng %>" placeholder="text" required=" ">
