...
<!-- login -->
		<div class="w3_login">
			<h3>Medicines Need To Be Replaced</h3>
		<table style="margin-top: 80px;">
					...
					<tr>
						...
						<td width="150px"> Medicine Brand Name</td>
						<td width="150px"> Price</td>
						<td width="150px"> Quantity Available</td>
						<td width="150px"> Date of Manufacturing</td>
						<td width="150px"> Expiry Date</td>
				...
				PreparedStatement ps1 = con.prepareStatement("select * from medicine_tbl where status=? and mname=?");
				ps1.setString(1,"needtobereplaced");
