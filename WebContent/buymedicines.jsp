...
<!-- login -->
		<div class="w3_login">
			...
			<div class="w3_login_module">
				...
				<div class="form">
					<h2>Buy Medicines</h2>
					<form action="BuyMedicines" method="post">
					   <input type="text" name="uname" placeholder="User Name" required=" ">
					  <input type="text" name="medname" placeholder="Medicine Name" required=" ">
					  <input type="text" name="mname" placeholder="MedicalName" required=" ">
					   <input type="text" name="uadress" placeholder="User Adress" required=" ">
