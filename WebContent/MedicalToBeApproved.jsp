			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						<li><a href="MedicalToBeApproved.jsp">Aprove Medical</a></li>
												<li class="dropdown mega-dropdown active">
							<a href="MedicalsApproved.jsp" >View Medical<span class=""></span></a>				
								
						</li>
					
						
	<!-- <li class="dropdown">
							<a href="newuser.html">View Complaints<span class=></span></a>
...
<!-- login -->
		<div class="w3_login"style="margin-top: -200px;">
			<h3>Medicals to be Approved</h3>
		<table style="margin-top: 100px;">
					<thead>
					
					<tr>
						<td width="150px"> Medical Id </td>
						<td width="150px"> Medical Name </td>
						<td width="150px"> Medical Owner Name </td>
				...
				PreparedStatement ps1 = con.prepareStatement("select * from medicalforapproval_tbl where status=?");
				...
				<td> <%=rs.getString("mcontactnumber")%></td>
			    <td><a href="ApproveSpecific.jsp?memail=<%=rs.getString("memail")%>">Approve</a></td>
				</tr>
			<%
				}
			}
