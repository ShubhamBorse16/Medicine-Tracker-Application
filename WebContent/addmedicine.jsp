...
<!-- login -->
		<div class="w3_login">
			...
			<div class="w3_login_module">
				...
				<div class="form">
					<h2>Fill Medicine Details</h2>
					<form action="AddMedicine" method="post">
					  <input type="text" name="medname" placeholder="Medicine Name" required=" ">
					  <input type="text" name="medbrandname" placeholder="Medicine Brand Name" required=" ">
					  <input type="text" name="medprice" placeholder="Price of Medicine" required=" ">
					   <input type="text" name="quantityavailable" placeholder="Quantity Available" required=" ">
						<!--  <input type="text" name="mname" placeholder="Your Medical Name" required=" ">  ---->  
			
			
					  Manufactured Date  
					    <input type="date" name="medadddate" placeholder="Date of import of medicine" required=" ">
					    <br>
					     Expiry Date
					      <input type="date" name="medexpirydate" placeholder="Expiry Date of Medicine" required=" ">
